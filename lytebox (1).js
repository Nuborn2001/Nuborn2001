...
function Lytebox() {
	...
	/*** Configure Lytebox ***/
		...
		this.fixedPosition		= false;			// if true, viewer will remain in a fixed position, otherwise page scrolling will be allowed
		...
		this.__navType			= 3;			// 1 = "Prev/Next" buttons on top left and left
													...
													// 3 = navType_1 + navType_2 (show both) navigation bar on top
	...
	/*** Configure Lyteframe (html viewer) Options ***/
		...
		this.__height			= '75%';		// default height of content viewer
		this.__scrollbars		= 'yes';		// controls the content viewers scollbars -- options are auto|yes|no
